...
interface FooterProps {
  onNavigate: (view: 'home' | 'history' | 'apply' | 'admin' | 'partnership' | 'activity') => void;
}
    ...
    <footer className="bg-white border-t border-gray-100 pt-20 pb-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-10">
        ...
        <div className="col-span-2 space-y-6">
          ...
          <div className="flex space-x-4">
            ...
            <a 
              ...
              className="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center text-slate-600 hover:bg-gradient-to-tr hover:from-[#fd5949] hover:to-[#d6249f] hover:text-white transition-all cursor-pointer shadow-sm"
              title="Instagram"
            >
            ...
            {/* Other Placeholders */}
            <div className="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center text-slate-600 hover:bg-[#2563EB] hover:text-white transition-colors cursor-pointer text-xs font-bold" title="Intranet (Example)">In</div>
            <div className="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center text-slate-600 hover:bg-[#2563EB] hover:text-white transition-colors cursor-pointer text-xs font-bold" title="Everytime (Example)">Et</div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="text-sm text-slate-600 space-y-2">
            <li><button onClick={() => onNavigate('activity')} className="hover:text-[#2563EB] font-medium transition-colors text-left">데이터 저널리즘</button></li>
            <li><button onClick={() => onNavigate('activity')} className="hover:text-[#2563EB] font-medium transition-colors text-left">엘리트 빌더</button></li>
            <li><button onClick={() => onNavigate('activity')} className="hover:text-[#2563EB] font-medium transition-colors text-left">인사이트 리그</button></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-gray-50 flex flex-col md:flex-row justify-between items-center text-xs text-slate-400 gap-4">
        ...
        <div className="flex space-x-6 items-center">
          ...
          {/* Hidden Admin Link for Demo Purposes */}
